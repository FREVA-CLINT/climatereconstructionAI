...
class ConvLSTMBlock(nn.Module):
    def __init__(self, in_channels, out_channels, img_size, kernel, stride, padding, dilation, groups):
        super().__init__()
        ...
        if cfg.weights:
            self.lstm_conv.apply(weights_init(cfg.weights, random_seed=cfg.random_seed))
