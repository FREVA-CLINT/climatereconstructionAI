...
class PConvUNetPercipitation(PConvUNet):
    def __init__(self, layer_size=7, input_channels=3 if local_settings.time else 3, upsampling_mode='nearest'):
        super().__init__()
...
class PConvUNetTemperature(PConvUNet):
    def __init__(self, layer_size=3, input_channels=3 if local_settings.time else 3, upsampling_mode='nearest'):
        super().__init__()
        self.freeze_enc_bn = False
        self.upsampling_mode = upsampling_mode
        self.layer_size = layer_size
