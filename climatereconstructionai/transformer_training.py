...
def train(model, training_settings, model_settings={}):
    ...
    if rank==0:
        dataset_train = NetCDFLoader_lazy(source_files_train, 
                                    ...
                                    p_average = training_settings['p_average'] if 'p_average' in training_settings else 0,
                                    p_average_dropout = training_settings['p_average_dropout'] if 'p_average_dropout' in training_settings else 0,
                                    max_average_lvl= training_settings['max_average_lvl'] if 'max_average_lvl' in training_settings else 0,
