...
# --snapshot-dir /work/bb1152/k204233/climatereconstructionAI/climatereconstructionAI/snapshots/precipitation/radolan-prev-next-rea/ \
# --log-dir /work/bb1152/k204233/climatereconstructionAI/climatereconstructionAI/logs/precipitation/radolan-prev-next-rea/ \
# --out-channels 1 \
# --lstm-steps 0 \
# --prev-next-steps 1 \
# --max-iter 100000 \
...
singularity run --bind /work/bb1152/k204233/ --nv /work/bb1152/k204233/climatereconstructionAI/torch_img_levante.sif \
 ...
 --out-channels 1 \
 --max-iter 200000 \
 --resume /work/bb1152/k204233/climatereconstructionAI/climatereconstructionAI/snapshots/precipitation/radolan-prev-next-rea/ckpt/100000.pth \
 --finetune \
 --log-interval 100 \
 --eval-timesteps 2143,2144,2145,2146,2147 \
 --save-model-interval 10000
