...
singularity run --bind /work/bb1152/k204233/ --nv /work/bb1152/k204233/climatereconstructionAI/torch_img_mistral.sif \
 ...
 --mask-dir masks/ \
 --snapshot-dir snapshots/precipitation/128x128/2007-2013/lstm-prev-next-hole/ckpt/430000.pth \
 --evaluation-dirs evaluation/precipitation/128x128/2007-2011/lstm-prev-next-hole/ \
 --prev-next-steps 0 \
 --lstm-steps 2 \
 --partitions 1177 \
 --eval-names Simple,LSTM \
 --out-channels 1 \
 --infill test \
# --create-report \
# --create-video \
