...
evaluator = LSTMEvaluator(args.evaluation_dir, args.mask_dir, args.data_root_dir + 'test_large/', args.data_type)
device = torch.device(args.device)


if args.infill:
    dataset_val = LSTMNetCDFDataLoader(args.data_root_dir, args.mask_dir, args.infill, args.data_type, args.lstm_steps)
