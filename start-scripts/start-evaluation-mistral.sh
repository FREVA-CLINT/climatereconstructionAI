...
singularity run --bind /work/bb1152/k204233/ --nv /work/bb1152/k204233/climatereconstructionAI/torch_img_mistral.sif \
 ...
 --evaluation-dirs evaluation/precipitation/radolan-simple-2007-2013/,evaluation/precipitation/radolan-rea2-tas/,evaluation/precipitation/radolan-rea2-celsius/,evaluation/precipitation/radolan-rea2-fusion/,evaluation/precipitation/radolan-fusion/ \
 --lstm-steps 0 \
 --partitions 1177 \
 --eval-names Simple,Kelvin,Celsius,Fusion,Fusion++ \
 --out-channels 1 \
 --create-report \
# --infill test \
